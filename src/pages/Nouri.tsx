...
import nouriWordmarkPng from '@/imports/Asset_3-1.png'
import brandMarkPng from '@/imports/Asset_2.png'
import backPanelImg from '@/imports/Nouri-10.png'
...
const IMG = {
  ...
  scoops:      'https://images.unsplash.com/photo-1629385701021-fcd568a743e8?w=1400&h=900&fit=crop&auto=format',
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <Reveal delay={80}>
            ...
            <div className="nr-four-col" style={{ marginBottom: 64 }}>
              {[
                { num: '01', name: 'Primary',        bg: '#EFE7DA', fg: '#241C15', desc: 'Main brand signature. Used across packaging, website and primary communications.' },
                { num: '02', name: 'Tagline lockup', bg: '#EFE7DA', fg: '#241C15', sub: 'Delicious first. Nourishing always.', desc: 'For campaign moments and print where the brand promise accompanies the wordmark.' },
                { num: '03', name: 'Reversed',       bg: '#241C15', fg: '#F7F1E2', desc: 'For dark backgrounds, photography overlays and selected flavour field applications.' },
                { num: '04', name: 'Brand mark',     bg: '#EFE7DA', fg: '#241C15', mark: true, desc: 'Compact expression for favicons, app icons, lids and small-format applications.' },
              ].map((v) => (
                <div key={v.num}>
                  <div style={{
                    borderRadius: 10,
                    ...
                    {v.mark ? (
                      <img src={brandMarkPng} alt="nouri brand mark" style={{ height: 48, width: 'auto', display: 'block' }} />
                    ) : (
                      <>
                        <div style={{ height: 36, overflow: 'hidden' }}>
                          <img
                            src={nouriWordmarkPng}
                            alt="nouri"
                            style={{ height: 72, width: 'auto', display: 'block', transform: v.fg === '#F7F1E2' ? 'translateY(0)' : 'translateY(-50%)' }}
                          />
                        </div>
                        {v.sub && (
                          <p style={{ fontFamily: 'var(--font-nouri-body)', fontSize: 9, color: v.fg, opacity: 0.65, letterSpacing: '0.06em', lineHeight: 1.5 }}>
                            {v.sub}
                          </p>
                        )}
                      </>
